...
export default function AboutPage() {
	return (
		<>
			<SEO
				title='About'
				description='Learn about SegmentAI - a free, privacy-focused semantic segmentation tool. Discover our AI models, features, and how to integrate with your applications.'
				keywords='about segmentai, semantic segmentation tool, AI models, image analysis API, privacy-focused AI'
			/>
			<main
				className='min-h-[calc(100vh-73px)]'
				role='main'
				aria-label='About SegmentAI'
			>
				<div className='max-w-3xl mx-auto px-4 py-12'>
					...
					>
						SegmentAI is a web-based semantic segmentation tool that allows you to quickly analyze images
						using cutting-edge deep learning models. No signup required — just upload and get results.
					</motion.p>
					...
					>
						...
						<motion.a
							...
							whileTap={{ scale: 0.98 }}
							aria-label='View SegmentAI source code on GitHub (opens in new tab)'
						>
							<Github
								className='w-4 h-4'
								aria-hidden='true'
